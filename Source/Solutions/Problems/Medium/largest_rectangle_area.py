...
def largest_rectangle_area(heights):
    ...
    # Append sentinel value to flush remaining heights
    heights.append(0)
    stack = []
    max_area = 0
...
# at any point i, move to left and right, if value is larger.
# area = i * (right-left+1)
def largest_rectangle_area_bruteforce(heights):
    ...
    for i in range(n):
        ...
        # Expand to the left, if left height is larger
        left = i
        while left > 0 and heights[left - 1] >= height:
            left -= 1

        # Expand to the right, if right height is larger
        right = i
...
#i=0, stack=[], 
#i=1, stack[0], height 5, width=1 from 5, area=5
#i=2, stack[1], height 4, width=2 from 5, area=8
#i=3, stack[2], height 3, width=3 from 5, area=9
#i=4, stack[3], height 2, width=4 from 5, area=8
#i=5, stack[4], height 1, width=5 from 5, area=5

nums = [1, 2, 3, 4, 5]
#i=0, stack=[], 
#i=1, stack[0], 1 > 2 false,
#i=2, stack[0,1], 2 > 3 false,
#i=3, stack[0,1,2], 3 > 4 false,
#i=4, stack[0,1,2,3], 4 > 5 false,
#i=5, stack[0,1,2,3,4], 5 > 0 true, 
    # height = 5, width = 5-3-1 = 1, area=5
    # height = 4, width = 5-2-1 = 2, area=8
    # height = 3, width = 5-1-1 = 3, area=9
    # height = 2, width = 5-0-1 = 4, area=8
